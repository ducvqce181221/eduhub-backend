...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('COURSE_ENROLLED', 'QUIZ_SUBMITTED', 'COURSE_COMPLETED', 'SYSTEM_BROADCAST');
...
-- AddForeignKey
ALTER TABLE "quiz_attempt_answers" ADD CONSTRAINT "quiz_attempt_answers_selected_answer_id_fkey" FOREIGN KEY ("selected_answer_id") REFERENCES "answers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
